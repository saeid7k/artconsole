...
Route::middleware(['auth', 'verified'])->group(function () {
  ...
  Route::prefix('contacts')->name('contacts.')->group(function () {
    ...
    Route::post('/top-selling-artists', [App\Http\Controllers\ContactController::class, 'topSellingArtists'])->name('top-selling-artists');
    Route::post('/top-customers', [App\Http\Controllers\ContactController::class, 'topCustomers'])->name('top-customers');
  ...
  Route::prefix('artworks')->name('artworks.')->group(function () {
    ...
    Route::get('/get-by-ids', [App\Http\Controllers\ArtworkController::class, 'getByIds'])->name('get-by-ids');
    ...
    Route::post('/get-images-by-ids', [App\Http\Controllers\ArtworkController::class, 'getImagesByIds'])->name('get-images-by-ids');
    ...
    Route::post('/recent', [App\Http\Controllers\ArtworkController::class, 'recent'])->name('recent');
  });

  Route::prefix('members')->name('members.')->group(function () {
    Route::get('{gallery}', [App\Http\Controllers\MemberController::class, 'getMembers'])->name('all');
    Route::post('{gallery}/add', [App\Http\Controllers\MemberController::class, 'addMember'])->name('add')->middleware([DemoForbidden::class]);
  ...
  Route::prefix('subscription')->name('subscription.')->middleware(DemoForbidden::class)->group(function () {
    ...
    Route::get('/payment-method-link', [App\Http\Controllers\SubscriptionController::class, 'getPaymentMethodLink'])->name('payment-method-link');
